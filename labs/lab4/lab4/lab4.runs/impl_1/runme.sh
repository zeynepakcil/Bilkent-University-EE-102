...
HD_PWD='C:/Users/zeyne/Desktop/Spring22-23/ee102/lab4/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log muxFile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source muxFile.tcl -notrace
