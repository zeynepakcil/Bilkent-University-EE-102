...
HD_PWD='C:/Users/zeyne/Desktop/Spring22-23/ee102/lab4/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log muxFile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source muxFile.tcl
